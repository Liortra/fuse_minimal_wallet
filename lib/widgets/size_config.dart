...
class SizeConfig {
  ...
  static double get spacing_small_vertical =>
      safeBlockVertical * 2 * safeIsMobile;

  static double get spacing_small_plus_vertical =>
      safeBlockVertical * 2.5 * safeIsMobile;

  static double get spacing_medium_vertical =>
      safeBlockVertical * 3 * safeIsMobile;

  static double get spacing_normal_vertical =>
      safeBlockVertical * 4 * safeIsMobile;

  static double get spacing_large_vertical =>
      safeBlockVertical * 7 * safeIsMobile;

  static double get spacing_extra_vertical =>
      safeBlockVertical * 9 * safeIsMobile;

  static double get spacing_small_horizontal =>
      safeBlockHorizontal * 2 * safeIsMobile;

  static double get spacing_small_plus_horizontal =>
      safeBlockHorizontal * 2.5 * safeIsMobile;

  static double get spacing_medium_horizontal =>
      safeBlockVertical * 3 * safeIsMobile;

  static double get spacing_normal_horizontal =>
      safeBlockVertical * 4 * safeIsMobile;

  static double get spacing_large_horizontal =>
      safeBlockVertical * 7 * safeIsMobile;

  static double get spacing_extra_horizontal =>
      safeBlockVertical * 9 * safeIsMobile;

  static double get font_subscription =>
  ...
  static double get font_medium_plus =>
